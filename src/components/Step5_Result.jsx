        ...
        <div className="glass-card" style={{ padding: '2rem' }}>
          ...
          <table className="result-table">
            <tbody>
              ...
              <tr><td>Ergänz. FZ</td><td className="num">{fmt(result.apr25.efz)}</td></tr>
        ...
        <div className="glass-card" style={{ padding: '2rem' }}>
          ...
          <table className="result-table">
            <tbody>
              ...
              <tr><td>Ergänz. FZ</td><td className="num">{fmt(result.may26.efz)}</td></tr>
      ...
      <div className="glass-card mb-6" style={{ padding: '2rem' }}>
        ...
        <div style={{ overflowX: 'auto' }}>
          <table className="result-table">
            ...
            <tbody>
              <tr>
                <td><strong>§ 79b</strong> – Einmalzahlung 2021<br/><span className="text-sm text-muted">138 € einmalig</span></td>
                <td>138 € × {data.m['2021'] > 0 ? 1 : 0}</td>
                <td className="num">{fmt(result.n_79b)}</td>
              </tr>
              <tr>
                <td><strong>§ 79c</strong> – Einmalzahlung 2025<br/><span className="text-sm text-muted">A16/W1/R2</span></td>
              ...
              <tr>
                <td><strong>§ 79d</strong> – Kinder 1 & 2<br/><span className="text-sm text-muted">41/9/52 € pro Kind/Mon.</span></td>
              ...
              <tr>
                <td><strong>§ 79a</strong> – Ergänz. FZ rückwirkend<br/><span className="text-sm text-muted">§ 41/41a abzüglich Einkommen</span></td>
                <td>
              ...
              <tr>
                <td><strong>§ 79e</strong> – 3+ Kinder 2017–04/26</td>
